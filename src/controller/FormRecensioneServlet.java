...
public class FormRecensioneServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Recensione recensione = new Recensione(Integer.parseInt(request.getParameter("valutazione")),request.getParameter("testo"),Integer.parseInt(request.getParameter("libro_id")));
